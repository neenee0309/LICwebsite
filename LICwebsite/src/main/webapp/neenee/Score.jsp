...
<body>
	<div class="navbar navbar">
		...
		<div class="form-group row">
				<label class="col-md-3 col-form-label" for="select1">เงินเดือนก่อนลาออก </label>
					<div class="col-md-9">
						<select id="select1" name="select1" class="form-control">
							<option value="0">--เลือกเงินเดือนก่อนลาออก--</option>
							<option value="1">ต่ำกว่า 10,000  บาท</option>
							<option value="2">10,000 - 15,000   บาท</option>
							<option value="3">15,000 - 20,000  บาท</option>
							<option value="4">20,000 - 25,000  บาท</option>
							<option value="5">25,000 - 30,000  บาท</option>
							<option value="6">30,000 - 40,000  บาท</option>
							<option value="7">40,000 - 50,000  บาท</option>
							<option value="8">50,000 - 100,000  บาท</option>
							<option value="9">100,000  บาทขึ้นไป</option>
						</select>
					</div>
 		</div>
 		
 		<div class="form-group row">
			<label class="col-md-3 col-form-label" for="text-input">คะแนน :</label>
				<div  >
		...
		<div class="form-group row">
			<label class="col-md-3 col-form-label" for="text-input">Backlist :</label>
				<div>
					
					<img  style="width: 46px; height: 44px;"  src="img/no-01.png">
					<img  style="width: 46px; height: 44px;"  src="img/30-01.png">
					<img  style="width: 46px; height: 44px;"  src="img/prison-02-01.png">
							...
							<h5 style="text-align:center;">
											<a href=""><img src="img/own-01.png"></a>
											<a href="UserReport"><img src="img/save-01.png"></a>
											<a href="/"><img src="img/cancel-01.png"></a>                                 		
    						</h5>
						</div>
					</div>
				</div>
