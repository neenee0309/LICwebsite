...
<body>
	<div class="navbar navbar">
		...
		<div class="form-group row">
			<label class="col-md-3 col-form-label" for="text-input">เหตุผลของการแก้ไขข้อมูล :</label>
				<div class="col-md-9">
					<input type="text" id="text-input" name="text-input" class="form-control" placeholder="">
							...
							<h5 style="text-align:center;">
											<a href="AllUser"><img src="img/save-01.png"></a>
											<a href="EditForOwner"><img src="img/cancel-01.png"></a>                                 		
    						</h5>
    						<h5 style="padding-left: 50px;"><span class="help-block"><b>* กรณีมีการร้องทุกข์จาก user(พนักงาน)</b></span></h5>
