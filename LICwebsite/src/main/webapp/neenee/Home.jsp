            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="#price">Portfolio</a></li>
                        <li><a href="#business">About</a></li>
                        <li><a href="#contact">Contact</a></li>
                        <li class="login"><a href="Admin">...</a></li>
                    </ul>
                        ...
                        <div class="home-wrapper">
                            <div class="col-md-10 col-md-offset-1">
                                <div class="home-content">
                                    ...
                                    <h1>Labor  Information  Center</h1>
                                  

                                    <div class="container">
        								<a href="Login" class="btn btn-primary btn-xl rounded-pill mt-5">LOGIN</a>
        								<a href="SelectRegister" class="btn btn-primary btn-xl rounded-pill mt-5">REGISTER</a>
